...
face_cascade = cv2.CascadeClassifier('home/pi/openCV-examples/face-detection/haarcascade_frontalface_default.xml')
eye_cascade = cv2.CascadeClassifier('home/pi/openCV-examples/face-detection/haarcascade_eye.xml')
...
while(True):
   ...
   dogs = dog_cascade.detectMultiScale(gray, 1.3, 5)
   for (x,y,w,h) in dogs:
